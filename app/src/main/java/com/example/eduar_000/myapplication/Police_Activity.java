...
public class Police_Activity extends FragmentActivity {
    ...
    private class searchAddress extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "";
            String url = "https://maps.googleapis.com/maps/api/place/search/json?location="+latitude+","+longitude+"&types=police&rankby=distance&sensor=false&key=AIzaSyCsCnOOpUs7UpipUFeNwCIl5BAXPHdTGlQ";
