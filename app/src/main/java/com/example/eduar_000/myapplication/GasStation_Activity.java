...
public class GasStation_Activity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gas_station_);
    ...
    private class searchAddress extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "";
            String url = "https://maps.googleapis.com/maps/api/place/search/json?location="+latitude+","+longitude+"&types=gas_station&rankby=distance&sensor=false&key=AIzaSyCsCnOOpUs7UpipUFeNwCIl5BAXPHdTGlQ";
