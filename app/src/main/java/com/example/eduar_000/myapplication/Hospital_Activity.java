...
public class Hospital_Activity extends FragmentActivity {
    ...
    private class searchAddress extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "";
            String url = "https://maps.googleapis.com/maps/api/place/search/json?location="+latitude+","+longitude+"&types=hospital&rankby=distance&sensor=false&key=AIzaSyCsCnOOpUs7UpipUFeNwCIl5BAXPHdTGlQ";
    ...
    public void addPolyLine(GoogleMap map, LatLng latLng1,LatLng latLng2) {
        PolylineOptions polylineOptions = new PolylineOptions();
        polylineOptions.add(new LatLng(latLng1.latitude, latLng1.longitude));
        polylineOptions.add(new LatLng(latLng2.latitude, latLng2.longitude));
